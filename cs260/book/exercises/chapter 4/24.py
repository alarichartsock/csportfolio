#24: Implement a deque using unordered list
...
class UnorderedListDeque:
    ...
    def addRear(self,item):
        """Adds a list to the queue"""
        self.unorderedlist.insert(self.unorderedlist.size()-2,item)
