...
class testBinaryHeap(unittest.TestCase):
    """Tests to make sure that the binary heap sort is working."""

    def testParseTree(self):
        """Acts as a main driver for the program, tests binary heap sort"""
        self.assertEqual(heapSort([10,5,3,2,6]),[2, 3, 5, 6, 10])
