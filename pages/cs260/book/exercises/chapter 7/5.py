...
class BinarySearchTree:
    ...
    def containsKey(self,key):
        """Returns True if the BinarySearchTree already contains the key provided"""
        s = self.inOrder()
    ...
    def put(self, key, val):
        """Puts an item, val into the BinarySearchTree. The item will be ordered based on the key, which should correspond to the items value. Does not accept duplicates."""
